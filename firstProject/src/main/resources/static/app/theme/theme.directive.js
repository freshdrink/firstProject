	...
	function pagingMaker($interval){
		return {
			...
			template :
				...
				+ '<li class="page-item" ng-class="pagination.first ? \'\' : \'none\'" ng-click="first();"><a class="page-link">&Lang;</a></li>'
				+ '<li class="page-item" ng-class="pagination.prev ? \'\' : \'none\'" ng-click="prev();"><a class="page-link">&lang;</a></li>'
				+ '<li class="page-item" ng-repeat="p in pagination.pages | limitTo : pagination.length" ng-click="update(p)"><a class="page-link">{{p}}</a></li>'
				+ '<li class="page-item" ng-class="pagination.next ? \'\' : \'none\'" ng-click="next();"><a class="page-link">&rang;</a></li>'
				+ '<li class="page-item" ng-class="pagination.last ? \'\' : \'none\'" ng-click="last();"><a class="page-link">&Rang;</a></li>'
				+'</ul></nav>',
